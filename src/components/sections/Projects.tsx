          ...
          <div key={project.id} style={{ padding:"24px", borderRadius:"8px", border:"1px solid var(--border)", backgroundColor:"var(--surface)" }}>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:"8px", flexWrap:"wrap", gap:"8px" }}>
              <div style={{ display:"flex", alignItems:"center", gap:"8px" }}>
                ...
                {project.ongoing && <span style={{ fontSize:"0.65rem", padding:"2px 8px", borderRadius:"9999px", backgroundColor:"#dcfce7", color:"#16a34a", fontWeight:600 }}>Ongoing</span>}
              </div>
              <div style={{ display:"flex", gap:"8px", alignItems:"center" }}>
                <span style={{ fontSize:"0.7rem", color:"var(--muted)" }}>{project.difficulty}</span>
